...
// Your timezone
$THINKUP_CFG['timezone']                  = 'America/Chicago';
...
$THINKUP_CFG['db_user']                   = 'bricksco_user';
$THINKUP_CFG['db_password']               = 'Xianity9';
$THINKUP_CFG['db_name']                   = 'bricksco_thinkup';
...
|| (getenv("MODE")=="TESTS" && ! getenv("RD_MODE")=="1")) {
    ...
    $THINKUP_CFG['db_user']                   = 'bricksco_user';
    $THINKUP_CFG['db_password']               = 'Xianity9';
    $THINKUP_CFG['db_name']                   = 'bricksco_thinkup'; //by default, thinkup_tests
